...
const ordenController = new OrdenController_1.OrdenController();
/**
 * @swagger
 * /api/ordenes:
 *   post:
 ...
 */
router.post('/', auth_middleware_1.authenticate, ordenController.crearOrden);
/**
 * @swagger
 * /api/ordenes:
 *   get:
 ...
 */
router.get('/', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, ordenController.obtenerTodasLasOrdenes);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.get('/estadisticas', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, ordenController.obtenerEstadisticas);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/mis-ordenes', auth_middleware_1.authenticate, ordenController.obtenerMisOrdenes);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/usuario/:usuarioId', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, ordenController.obtenerOrdenesPorUsuario);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.get('/estado/:estado', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, ordenController.obtenerOrdenesPorEstado);
/**
 * @swagger
 * /api/ordenes/{id}:
 *   get:
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/:id', auth_middleware_1.authenticate, ordenController.obtenerOrdenPorId);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id/estado', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, ordenController.actualizarEstadoOrden);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/:id/pagar', auth_middleware_1.authenticate, ordenController.marcarComoPagada);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.post('/:id/cancelar', auth_middleware_1.authenticate, ordenController.cancelarOrden);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.post('/:id/reembolsar', auth_middleware_1.authenticate, authorize_middleware_1.adminOnly, ordenController.reembolsarOrden);
/**
 * @swagger
 * /api/ordenes/{id}:
 *   delete:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/:id', auth_middleware_1.authenticate, authorize_middleware_1.adminOnly, ordenController.eliminarOrden);
