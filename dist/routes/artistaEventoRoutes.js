...
const ArtistaEventoController_1 = require("../controllers/ArtistaEventoController");
const auth_middleware_1 = require("../middlewares/auth.middleware");
const authorize_middleware_1 = require("../middlewares/authorize.middleware");
const router = (0, express_1.Router)();
const artistaEventoController = new ArtistaEventoController_1.ArtistaEventoController();
/**
 * @swagger
 ...
 */
router.post('/:eventoId/artistas', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, (req, res) => artistaEventoController.asignarArtista(req, res));
/**
 * @swagger
 * /api/eventos/{eventoId}/artistas:
 *   get:
 ...
 */
router.get('/:eventoId/artistas', (req, res) => artistaEventoController.obtenerArtistasDeEvento(req, res));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/NotFoundError'
 */
router.get('/:eventoId/artistas/headliners', (req, res) => artistaEventoController.obtenerHeadliners(req, res));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:eventoId/artistas/:artistaId', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, (req, res) => artistaEventoController.actualizarAsignacion(req, res));
/**
 * @swagger
 * /api/eventos/{eventoId}/artistas/{artistaId}:
 *   delete:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/:eventoId/artistas/:artistaId', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, (req, res) => artistaEventoController.removerArtista(req, res));
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/NotFoundError'
 */
router.get('/:artistaId/eventos', (req, res) => artistaEventoController.obtenerEventosDeArtista(req, res));
exports.default = router;
//# sourceMappingURL=artistaEventoRoutes.js.map