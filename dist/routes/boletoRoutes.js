...
const boletoController_1 = require("../controllers/boletoController");
const auth_middleware_1 = require("../middlewares/auth.middleware");
const authorize_middleware_1 = require("../middlewares/authorize.middleware");
const router = (0, express_1.Router)();
const boletoController = new boletoController_1.BoletoController();
/**
 * @swagger
 * /api/boletos/lote:
 *   post:
 ...
 */
router.post('/lote', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, boletoController.crearBoletosEnLote);
/**
 * @swagger
 * /api/boletos:
 *   post:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.post('/', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, boletoController.crearBoleto);
/**
 * @swagger
 * /api/boletos:
 *   get:
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/', auth_middleware_1.authenticate, boletoController.obtenerTodosLosBoletos);
/**
 * @swagger
 * /api/boletos/{id}:
 *   get:
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/:id', auth_middleware_1.authenticate, boletoController.obtenerBoletoPorId);
/**
 * @swagger
 * /api/boletos/{id}:
 *   put:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, boletoController.actualizarBoleto);
/**
 * @swagger
 * /api/boletos/{id}:
 *   delete:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/:id', auth_middleware_1.authenticate, authorize_middleware_1.adminOnly, boletoController.eliminarBoleto);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/evento/:eventoId', auth_middleware_1.authenticate, boletoController.buscarBoletosPorEvento);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/evento/:eventoId/disponibles', auth_middleware_1.authenticate, boletoController.obtenerBoletosDisponibles);
/**
 * @swagger
 ...
 */
router.post('/:id/comprar', auth_middleware_1.authenticate, boletoController.comprarBoleto);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.post('/:id/liberar', auth_middleware_1.authenticate, authorize_middleware_1.adminOnly, boletoController.liberarBoleto);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/evento/:eventoId/estadisticas', auth_middleware_1.authenticate, boletoController.obtenerEstadisticasEvento);
/**
 * @swagger
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/evento/:eventoId/verificar-disponibilidad', auth_middleware_1.authenticate, boletoController.verificarDisponibilidad);
/**
 * @swagger
 * /api/boletos/evento/{eventoId}:
 *   delete:
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/evento/:eventoId', auth_middleware_1.authenticate, authorize_middleware_1.adminOrOrganizer, boletoController.eliminarBoletosPorEvento);
