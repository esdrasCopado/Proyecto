...
class SongService {
     ...
     */
    async obtenerSongsPorAlbum(albumId) {
        if (albumId <= 0) {
     ...
     */
    async buscarSongsPorTitulo(titulo) {
     ...
     */
    async actualizarSong(id, datosActualizar) {
        if (id <= 0) {
            throw new Error('El ID de la canción debe ser válido');
        }
     ...
     */
    async contarSongsPorAlbum(albumId) {
        if (albumId <= 0) {
            throw new Error('El ID del álbum debe ser válido');
        }
     ...
     */
    async obtenerDuracionTotalAlbum(albumId) {
        if (albumId <= 0) {
            throw new Error('El ID del álbum debe ser válido');
        }
