...
import { Artista, IArtistaData } from '../models/Artista';
...
export class ArtistaService {
     ...
     */
    private validarDatosArtista(artistaData: {
        nombre: string;
        genero: string;
        contacto: string;
        paisOrigen: string;
     ...
     */
    async obtenerArtistaPorId(id: number): Promise<IArtistaData | null> {
        if (id <= 0) {
     ...
     */
    async obtenerTodosLosArtistas(): Promise<IArtistaData[]> {
     ...
     */
    async actualizarArtista(id: number, datosActualizar: {
        nombre?: string;
        genero?: string;
        contacto?: string;
        paisOrigen?: string;
