 ...
 */
router.post('/', authenticate, adminOnly, (req, res) => albumController.create(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id', authenticate, adminOnly, (req, res) => albumController.update(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/:id', authenticate, adminOnly, (req, res) => albumController.delete(req, res));
