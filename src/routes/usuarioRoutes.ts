 ...
 */
router.get('/stats/count', authenticate, adminOrOrganizer, (req, res) => controller.getCount(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.get('/stats/general', authenticate, adminOrOrganizer, (req, res) => controller.getStats(req, res));
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/nuevos', authenticate, adminOrOrganizer, (req, res) => controller.getNewUsers(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.get('/email/:email', authenticate, adminOnly, (req, res) => controller.getByEmail(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id/rol', authenticate, adminOnly, (req, res) => controller.changeRole(req, res));
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/', authenticate, adminOrOrganizer, (req, res) => controller.getAll(req, res));
 ...
 *         $ref: '#/components/responses/UnauthorizedError'
 */
router.get('/:id', authenticate, authorizeOwnerOrAdmin((req) => Number(req.params.id)), (req, res) => controller.getById(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id', authenticate, authorizeOwnerOrAdmin((req) => Number(req.params.id)), (req, res) => controller.update(req, res));
