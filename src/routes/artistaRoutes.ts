 ...
 */
router.post('/', authenticate, adminOnly, (req, res) => artistaController.create(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id', authenticate, adminOnly, (req, res) => artistaController.update(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/:id', authenticate, adminOnly, (req, res) => artistaController.delete(req, res));
