 ...
 */
router.post('/', authenticate, adminOnly, (req, res) => songController.create(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.put('/:id', authenticate, adminOnly, (req, res) => songController.update(req, res));
 ...
 *         $ref: '#/components/responses/ForbiddenError'
 */
router.delete('/:id', authenticate, adminOnly, (req, res) => songController.delete(req, res));
